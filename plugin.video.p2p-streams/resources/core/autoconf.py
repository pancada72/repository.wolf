...
trunkfolder = "https://github.com/akiaexport/download/raw/master"
version_control = trunkfolder + "/Control/versions.info"

#Linux Arm
sopcast_raspberry = trunkfolder + "/Defcontrol/Linux/arm/rpi2/sopcast-raspberry.tar.gz"
acestream_rpi2 = trunkfolder + "/Defcontrol/Linux/arm/rpi2/acestream-rpi2.tar.gz"

#Linux i386 and x86_64 (including openelec)
sopcast_linux_generico =  trunkfolder + "/Defcontrol/Linux/Sopcastx86_64i386/sopcast_linux.tar.gz"
openelecx86_64_sopcast = trunkfolder + "/Defcontrol/Linux/x86_64/Openelec/sopcast_openelec64.tar.gz"
openeelcx86_64_acestream = trunkfolder + "/Defcontrol/Linux/x86_64/Openelec/acestream_openelec64_3051.tar.gz"
openelecxi386_sopcast = trunkfolder + "/Defcontrol/Linux/i386/openelec/sopcast_openeleci386.tar.gz"
openeelcxi386_acestream = trunkfolder + "/Defcontrol/Linux/i386/openelec/acestream_openeleci386_303fix.tar.gz"
#gen linux
acestream_linux_x64_generic = trunkfolder + "/Defcontrol/Linux/x86_64/acestream-linux-x86_64_3051.tar.gz"
acestream_linux_i386_generic = trunkfolder + "/Defcontrol/Linux/i386/acestream-linux-i386_303.tar.gz"
#Android
sopcast_apk = trunkfolder + "/Defcontrol/Android/SopCast.apk.tar.gz"
acestreamengine_apk_arm = trunkfolder + "/Defcontrol/Android/AceStream-3.0.6-2in1.apk.tar.gz"
acestreamengine_apk_x86 = trunkfolder + "/Defcontrol/Android/AceStream-3.0.6-2in1.apk.tar.gz"
android_aceengine_arm = trunkfolder + "/Defcontrol/Android/org.acestream.engine-arm-3.0.6.tar.gz"
android_aceengine_x86 = trunkfolder + "/Defcontrol/Android/org.acestream.engine_x86.tar.gz"
android_aceplayer_arm = trunkfolder + "/Defcontrol/Android/AcePlayer-3.0.6-2in1.apk.tar.gz"
android_aceplayer_x86 = trunkfolder + "/Defcontrol/Android/AcePlayer-3.0.6-2in1.apk.tar.gz"
#Mac OSX #TODO
osx_i386_sopcast = trunkfolder + "/Defcontrol/MacOsx/i386/sopcast_osxi386.tar.gz"
osx_i386_acestream = trunkfolder + "/Defcontrol/MacOsx/AceStreamWineOSX.zip"
osx_x64_sopcast = trunkfolder + "/Defcontrol/MacOsx/x86_64/sopcast_osx64.tar.gz"
osx_x64_acestream = trunkfolder + "/Defcontrol/MacOsx/AceStreamWineOSX.zip"
#Windows Files
acestream_windows = trunkfolder + "/Defcontrol/Windows/acewindows-aceengine3.0.4.tar.gz"
srvany_executable = trunkfolder + "/Defcontrol/Windows/srvany.tar.gz"
srvany_permissions = trunkfolder + "/Defcontrol/Windows/sopcastp2p-permissions.txt"
